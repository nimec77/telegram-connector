...
use crate::telegram::converters::{
    ...
    convert_peer_to_channel, convert_raw_message, extract_audio_duration, extract_video_info,
    matches_media_filter_raw, message_timestamp, select_size_candidate, size_candidates,
    timestamp_from_raw,
};
...
impl TelegramClientTrait for TelegramClient {
    ...
    async fn get_channel_stats(
        ...
        channel_ref: &str,
        days_back: u32,
    ) -> Result<crate::telegram::ChannelStats, Error> {
        self.get_channel_stats_impl(channel_ref, days_back).await
    }
}
